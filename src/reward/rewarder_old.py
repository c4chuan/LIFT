...
class Rewarder:
    def __init__(self, model_path = "/data/pretrained_models/Qwen2.5-VL-7B-Instruct"):
...
if __name__ == '__main__':
    rewarder = Rewarder()
    shift_reward, zoom_reward = rewarder.reward(EXAMPLES['LIFT'][0]['answer'], "/data/wangzhenchuan/Projects/LIFT/data/example/example.png",
                                                visualize = True,
                                                visual_save = '/data/wangzhenchuan/Projects/LIFT/visualize_debug')
